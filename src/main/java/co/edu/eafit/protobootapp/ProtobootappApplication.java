...
//Se lanza y se ejecuta con http://localhost:8080 o la URL específica al proveedor del cloud
...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido! Esta aplicación ayuda a elevar números a sus potencias y otras características que no puedo decir.");
    }    
